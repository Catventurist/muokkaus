...
seo:
  title: Muokkaus
  description: Create stunning, fast and SEO-optimized documentation sites with Muokkaus.
---
...
#title
Make Beautiful [Docs]{.text-primary}.

#description
Build professional documentation with Muokkaus's powerful components, enhanced typography, and seamless Nuxt Content integration. The same system trusted by the entire [Nuxt ecosystem](https://nuxt.com).
...
#features
  ...
  #description
  Accordions, cards, callouts, tabs, steps, code blocks, and more - all provided by Muokkaus for interactive documentation.
  :::
...
::u-page-section{.dark:bg-gradient-to-b.from-neutral-950.to-neutral-900}
  ...
  links:
    ...
    - label: View on GitHub
      ...
      icon: i-simple-icons-github
  class: dark:bg-neutral-950
  description: Join some of developers building with Nuxt and Muokkaus. Get this
    template and start shipping today.
