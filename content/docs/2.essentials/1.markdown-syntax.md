...
Syntytieto supports most Markdown formatting options.
...
For linking within your documentation, use root-relative paths like `/docs/getting-started/installation`.
