---
title: Composables
description: Auto-imported scripts
navigation.icon: i-vscode-icons-folder-type-src
---

Use the composables/ directory to auto-import your Nuxt composables into your application.

::tip{to="https://nuxt.com/docs/4.x/directory-structure/app/composables"}
Read more on Nuxt website.
:: 

List of scripts

- [defineLocale](/docs/composables/define-locale)
- [defineShortcuts](/docs/composables/define-shortcuts)
- [extendLocale](/docs/composables/extend-locale)
- [extractShortcuts](/docs/composables/extract-shortcuts)
- [useFormField](/docs/composables/use-form-field)
- [useOverlay](/docs/composables/use-overlay)
- [useToast](/docs/composables/use-toast)
...
::tip{to="https://nuxt.com/docs/4.x/guide/concepts/auto-imports"}
Read more
::

::tip{to="https://nuxt.com/docs/4.x/examples/features/auto-imports"}
Look at examples
::
